...
- **JLC order LCSC swaps.** **F1** is `C883095` (the old `C37010` is not a real part). **U7** is ST USBLC6-2SC6 `C7519` (the old `C8678` is an SS34 Schottky). **Y1** is JLYE `C49207908` (Kyocera `C1857159` was a JLC SMT shortfall).
